...
<div  id = "html" fxLayout= "column" fxLayoutGap = "1.7rem"></div>
...
<div fxLayout = "column" fxLayoutAlign = "center center "  style="margin-top: 2rem; ">
    <button (click) = "download()" color = "primary" mat-raised-button>Download</button>
</div>
...
<h1 style="background-color:#4c86bd ; color : white">Your Education Details</h1>

<span *ngFor = "let item of this.resume.education " fxLayout = "column" fxLayoutGap = "1px" >

<h2 style="font-size : 1rem; font-weight: bold; color: blue"> {{item.field}} </h2>
...
<h1 style="background-color:#4c86bd ; color : white">Industrial Exposure </h1>
...
<h1 style="background-color:#4c86bd ; color : white">Objectives </h1>
...
<ng-template #skills> 
<h1 style="background-color:#4c86bd ; color : white">Skills </h1>
...
<h1 style="background-color:#4c86bd ; color : white">Interests </h1>
...
<ng-template #languages > 
    <h1 style="background-color:#4c86bd ; color : white">Languages </h1>

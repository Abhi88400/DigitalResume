...
<div class = "contactDetailStyle"  fxLayoutAlign = "center center" fxLayout = "column" fxLayoutGap = "1px">
...
<h1 style="background-color:grey ; color : white">Your Education Details</h1>

<span *ngFor = "let item of this.resume.education" >
...
<h1 style="background-color:grey ; color : white">Industrial Exposure </h1>
...
<h1 style="background-color:grey ; color : white">Objectives </h1>
...
<ng-template #skills> 
<h1 style="background-color:grey ; color : white">Skills </h1>
...
<h1 style="background-color:grey ; color : white">Interests </h1>
...
<ng-template #languages > 
    <h1 style="background-color:grey ; color : white">Languages </h1>

...
<h1 style="background-color:black ; color : white">Your Education Details</h1>
...
<h1 style="background-color:black ; color : white">Industrial Exposure </h1>
...
<h1 style="background-color:black ; color : white">Objectives </h1>
...
<ng-template #skills> 
<h1 style="background-color:black ; color : white">Skills </h1>
...
<h1 style="background-color:black ; color : white">Interests </h1>
...
<ng-template #languages > 
    <h1 style="background-color:black ; color : white">Languages </h1>
